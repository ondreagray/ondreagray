...
* **Kernel-Ridge Regression [fluid-dynamics-sim](https://github.com/ondreagray/fluid-dynamics-sim):** Designing a Kernel-Ridge Regression algorithm 
...
* **Fluid Simulation Over Different Timescales (link):** Simulating the Navier-Stokes equations using different initial conditions. Utilizes, scipy.integrate, finite difference methods and the Fast Fourier Transform (FFT).
  
### 🛠️ Tech Stack:
* **Languages:** Python (Primary)
* **Libraries:** Pyomo, NumPy, Pandas, SciPy Scikit-learn, Matplotlib
* **Focus Areas:** Linear Programming (LP), Mixed-Integer Linear Programming (MILP), Stochastic Optimization

### 📫 How to reach me:
* **LinkedIn:** www.linkedin.com/in/ondrea-robinson
* **Email:** ondreagray@gmail.com
<!--
**ondreagray/ondreagray** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
